    ...
    handler: httpAction(async (ctx, request) => {
        ...
        try {
            ...
            if (eventType === "user.created" || eventType === "user.updated") {
                ...
                // IMPORTANT: The token identifier must match what Clerk sends in JWTs
                // Typically: "https://<your-clerk-domain>|<user_id>"
                // We'll use a flexible approach or hardcode based on your issuer
                const tokenIdentifier = `${process.env.CLERK_ISSUER_URL || "https://clerk.wavelength.lol"}|${id}`;
