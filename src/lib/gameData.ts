...
export const funDeck: Card[] = [
    ...
    // 🤯 Wavelength Classics Pt 1 - Debate Starters
    { left: "Easy to Spell", right: "Hard to Spell" },
    { left: "Ethically Dubious", right: "Ethically Sound" },
    { left: "Useless Major", right: "Useful Major" },
    { left: "Smells Like Old People", right: "Smells Like Young People" },
    { left: "Tastes Like Childhood", right: "Tastes Like Adulthood" },
    { left: "Belongs in a Museum", right: "Belongs in the Trash" },
    { left: "Better in a Movie", right: "Better in Real Life" },
    { left: "Hard to Remember", right: "Hard to Forget" },
    { left: "Scarier in the Day", right: "Scarier at Night" },
    { left: "Overpowered", right: "Underpowered" },
    { left: "Good to be Early For", right: "Good to be Late For" },
    { left: "Has a Lot of Lore", right: "Has No Lore" },
    { left: "High Risk", right: "Low Risk" },
    { left: "Villain Origin Story", right: "Hero Origin Story" },
    { left: "Better When It's Broken", right: "Better When It's Whole" },
    { left: "Tastes Better Melted", right: "Tastes Better Frozen" },
    { left: "Would Survive a Nuclear Bomb", right: "Would Melt in the Sun" },
    { left: "Looks Like a Pokémon", right: "Looks Like a Digimon" },
    { left: "Feels Illegal but Isn't", right: "Feels Legal but Isn't" },
    { left: "Socially Acceptable", right: "Socially Unacceptable" },
    { left: "Requires a License", right: "Anyone Can Do It" },
    { left: "Good to Find in Your House", right: "Bad to Find in Your House" },
    { left: "Hard to Hide", right: "Easy to Hide" },
    { left: "Weird Thing to Have 10 Of", right: "Normal Thing to Have 10 Of" },
    { left: "Has Too Many Rules", right: "Needs More Rules" },
    { left: "Over-engineered", right: "Under-engineered" },
    { left: "Takes Too Long", right: "Over Too Soon" },
    { left: "Better Doing it Yourself", right: "Better Paying Someone Else" },
    { left: "Has a Dark Side", right: "Completely Pure" },
    { left: "Hard to Say", right: "Easy to Say" },

    // 🎭 Wavelength Classics Pt 2 - Media & Culture
    { left: "Better as a Book", right: "Better as a Movie" },
    { left: "Relatable", right: "Unrelatable" },
    { left: "Needs a Sequel", right: "Leave It Alone" },
    { left: "Cult Leader Energy", right: "Cult Follower Energy" },
    { left: "Better in the Summer", right: "Better in the Winter" },
    { left: "Good to be Famous For", right: "Bad to be Famous For" },
    { left: "Great at a Wedding", right: "Terrible at a Wedding" },
    { left: "A Scam", right: "A Bargain" },
    { left: "Needs Wi-Fi", right: "Better Without Wi-Fi" },
    { left: "10/10", right: "0/10" },
    { left: "Deserves More Hype", right: "Over-hyped" },
    { left: "Fun to Watch", right: "Fun to Play" },
    { left: "Hard to Draw", right: "Easy to Draw" },
    { left: "Hard to Explain", right: "Easy to Explain" },
    { left: "Good to be Seen Doing", right: "Bad to be Seen Doing" },
    { left: "A Phase", right: "A Lifestyle" },
    { left: "Best Pizza Topping", right: "Worst Pizza Topping" },
    { left: "Needs a Good Soundtrack", right: "Better in Silence" },
    { left: "Looks Cooler in Slow Motion", right: "Looks Dumber in Slow Motion" },
    { left: "Great to Inherit", right: "Terrible to Inherit" },
    { left: "Should Be Free", right: "Should Cost Money" },
    { left: "Good Secret to Keep", right: "Bad Secret to Keep" },
    { left: "Good Problem to Have", right: "Terrible Problem to Have" },
    { left: "Useless Superpower", right: "Useful Superpower" },
    { left: "Good to Have 1 Of", right: "Good to Have 100 Of" },
    { left: "Better Modern", right: "Better Vintage" },
    { left: "Good Surprise", right: "Bad Surprise" },
    { left: "Looks Expensive", right: "Looks Cheap" },
    { left: "Good Icebreaker", right: "Terrible Icebreaker" },
    { left: "A Sign of Wealth", right: "A Sign of Poverty" },

    // 🥑 Everyday & Opinions
    { left: "Round", right: "Pointy" },
    { left: "Flexible", right: "Rigid" },
    { left: "Fragile", right: "Durable" },
    { left: "Sticky", right: "Slippery" },
    { left: "Useful in an Apocalypse", right: "Useless in an Apocalypse" },
    { left: "Good for Your Health", right: "Bad for Your Health" },
    { left: "Feels Like a Chore", right: "Feels Like a Treat" },
    { left: "Good Reason", right: "Bad Excuse" },
    { left: "Good Routine", right: "Bad Routine" },
    { left: "Better Hot", right: "Better Cold" },
    { left: "Good Color", right: "Bad Color" },
    { left: "Good Pet", right: "Terrible Pet" },
    { left: "Scrap It", right: "Fix It" },
    { left: "A Good Sound", right: "A Bad Sound" },
    { left: "Good Habit", right: "Bad Habit" },
    { left: "Good Feeling", right: "Bad Feeling" },
    { left: "Overpriced", right: "Underpriced" },
    { left: "Too Sweet", right: "Too Savory" },
    { left: "A Good Vibe", right: "A Bad Vibe" },
    { left: "A Good Way to Die", right: "A Bad Way to Die" },
    { left: "A Good Way to Spend a Million Dollars", right: "A Bad Way to Spend a Million Dollars" },
    { left: "Historical Event You'd Want to Witness", right: "Historical Event You'd Run From" },
    { left: "Good Way to Start the Day", right: "Bad Way to Start the Day" },
    { left: "Good Way to End the Day", right: "Bad Way to End the Day" },
    { left: "Utopia", right: "Dystopia" },
    { left: "A Good Lie", right: "A Bad Truth" },
    { left: "A Miracle", right: "A Disaster" },
    { left: "A Masterpiece", right: "Trash" },
    { left: "Good Idea", right: "Terrible Idea" },
    { left: "Requires Strategy", right: "Requires Luck" }
];
