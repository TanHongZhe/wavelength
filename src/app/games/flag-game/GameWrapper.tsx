...
import { FlagGameEngine } from "@/components/minigames/flag-game/FlagGameEngine";
import { Button } from "@/components/ui/button";
import { Flag, Sparkles, Users, LogIn } from "lucide-react";
...
function GameWrapperContent() {
    ...
    return (
        <div className="relative w-full py-20 bg-gradient-to-b from-background via-purple-900/10 to-background flex flex-col items-center justify-center text-center overflow-hidden">
            ...
            >
                <motion.div
                    className="w-20 h-20 bg-gradient-to-br from-red-500 to-orange-500 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-xl shadow-red-500/20"
                ...
                <p className="text-xl text-muted-foreground font-medium max-w-2xl mx-auto mb-8">
                    Is it a Red Flag 🚩, Green Flag 🟢, or Beige Flag 🟧? Rate dating scenarios and see if you agree!
                </p>
